...
export const Dashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            {/* Sidebar */}
            <aside
                className={`fixed top-0 left-0 z-50 h-full w-64 bg-sidebar border-r border-sidebar-border transform transition-transform duration-300 lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
                                ...
                                <CardContent>
                                    <div className="space-y-3">
                                        <div className="flex items-center justify-between p-3 rounded-lg bg-destructive/5 border border-destructive/20">
                                            <div>
                                                <div className="font-medium text-foreground">Aluguel</div>
                                                <div className="text-sm text-muted-foreground">
                                                    Vence em 3 dias
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex items-center justify-between p-3 rounded-lg bg-accent/5 border border-accent/20">
                                            <div>
                                                <div className="font-medium text-foreground">Internet</div>
                                                <div className="text-sm text-muted-foreground">
                                                    Vence em 7 dias
                                                </div>
                                            </div>
